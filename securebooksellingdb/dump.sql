...
CREATE TABLE `book` (
  ...
  `title` varchar(45) DEFAULT 'Unnamed book',
  PRIMARY KEY (`id`),
...
INSERT INTO `client` VALUES (1,'Alice','passalice'),(2,'Bob','passbob');
...
CREATE TABLE `purchase` (
  ...
  CONSTRAINT `book_fk` FOREIGN KEY (`book`) REFERENCES `book` (`id`),
  CONSTRAINT `client_fk` FOREIGN KEY (`buyer`) REFERENCES `client` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-30 17:58:20
